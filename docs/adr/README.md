...
`docs/adr/` is the canonical ADR corpus for this parser repository.
...
- [0006](./0006-dbt-v2-json-compatibility-uses-schema-versions.md) - dbt v2 JSON compatibility by artifact schema version
