...
- [0011](./0011-cli-stdout-json-envelope-and-introspection-schemas-for-coding-agents.md) - optional JSON stdout envelope, flat `schema` introspection, and `stdout_json_schema` on command schemas
