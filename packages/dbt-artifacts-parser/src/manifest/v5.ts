 ...
 */
export interface HttpsSchemasGetdbtComDbtManifestV5Json {
 ...
 *
 * This interface was referenced by `HttpsSchemasGetdbtComDbtManifestV5Json`'s JSON-Schema
...
/**
 * FreshnessMetadata(dbt_schema_version: str = <factory>, dbt_version: str = '1.1.0b1', generated_at: datetime.datetime = <factory>, invocation_id: Union[str, NoneType] = <factory>, env: Dict[str, str] = <factory>)
 *
 * This interface was referenced by `HttpsSchemasGetdbtComDbtManifestV5Json`'s JSON-Schema
