 ...
 */
export interface HttpsSchemasGetdbtComDbtManifestV8Json {
 ...
 *
 * This interface was referenced by `HttpsSchemasGetdbtComDbtManifestV8Json`'s JSON-Schema
...
/**
 * FreshnessMetadata(dbt_schema_version: str = <factory>, dbt_version: str = '1.4.1', generated_at: datetime.datetime = <factory>, invocation_id: Optional[str] = <factory>, env: Dict[str, str] = <factory>)
 *
 * This interface was referenced by `HttpsSchemasGetdbtComDbtManifestV8Json`'s JSON-Schema
