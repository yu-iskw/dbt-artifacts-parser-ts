 ...
 */
export interface HttpsSchemasGetdbtComDbtRunResultsV4Json {
 ...
 *
 * This interface was referenced by `HttpsSchemasGetdbtComDbtRunResultsV4Json`'s JSON-Schema
...
/**
 * FreshnessMetadata(dbt_schema_version: str = <factory>, dbt_version: str = '1.0.0b2', generated_at: datetime.datetime = <factory>, invocation_id: Union[str, NoneType] = <factory>, env: Dict[str, str] = <factory>)
 *
 * This interface was referenced by `HttpsSchemasGetdbtComDbtRunResultsV4Json`'s JSON-Schema
